...
class HabitDetailsVC: UIViewController {
    ...
    let habitDetailsCalendarView = DetailsCalendarView()
    let habitDetailsStreakView   = DetailsStreakView()
    let habitDetailsChartView    = DetailsChartView()
    ...
    override func viewDidLayoutSubviews() {
        ...
        // Paging turned off due to xcode bug which prevents scroll to item working when it is active.
        habitDetailsChartView.collectionView.isPagingEnabled = false
        let section = 0
